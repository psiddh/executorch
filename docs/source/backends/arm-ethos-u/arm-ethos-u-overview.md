...
please refer to the [Arm Ethos-U Backend Tutorial](https://docs.pytorch.org/executorch/stable/backends/arm-ethos-u/tutorials/ethos-u-getting-started.html).
